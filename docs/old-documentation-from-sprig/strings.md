...
The [Conversion Functions](../conversion.html) contain functions for converting strings. The [String Slice Functions](../string\_slice.html) contains functions for working with an array of strings.
