...
func TestDeprecatedGet(t *testing.T) {
	tc := []pesticide.TestCase{
		...
		{Name: "TestInvaidArguments", Input: `{{get . "a" "b" }}`, ExpectedErr: "expected 2 arguments, got 3", Data: map[string]any{"a": 1}},
		{Name: "TestInvaidArgumentsType", Input: `{{get 1 2 }}`, ExpectedErr: "expected map or string, got int", Data: map[string]any{"a": 1}},
	}
...
func TestDeprecatedSet(t *testing.T) {
	tc := []pesticide.TestCase{
		...
		{Name: "TestInvaidArguments", Input: `{{$d := set . "a" 2 "b" 3}}{{$d}}`, ExpectedErr: "expected 3 arguments, got 5", Data: map[string]any{"a": 1}},
		{Name: "TestInvaidArgumentsType", Input: `{{$d := set "a" "a" 2}}{{$d}}`, ExpectedErr: "last argument must be a map[string]any", Data: map[string]any{"a": 1}},
		{Name: "TestInvaidArgumentsType", Input: `{{$d := set 1 "a" 2}}{{$d}}`, ExpectedErr: "expected map or string, got int", Data: map[string]any{"a": 1}},
	}
...
func TestDeprecatedUnset(t *testing.T) {
	tc := []pesticide.TestCase{
		...
		{Name: "TestInvaidArgumentsType", Input: `{{$d := unset "a" "a"}}{{$d}}`, ExpectedErr: "last argument must be a map[string]any", Data: map[string]any{"a": 1}},
		{Name: "TestInvaidArgumentsType", Input: `{{$d := unset 1 "a"}}{{$d}}`, ExpectedErr: "expected map or string, got int", Data: map[string]any{"a": 1}},
	}
...
func TestDeprecatedHasKey(t *testing.T) {
	tc := []pesticide.TestCase{
		...
		{Name: "TestInvaidArguments", Input: `{{hasKey . "a" "b"}}`, ExpectedErr: "expected 2 arguments, got 3", Data: map[string]any{"a": 1}},
		{Name: "TestInvaidArgumentsType", Input: `{{hasKey 1 "a"}}`, ExpectedErr: "expected map or string, got int", Data: map[string]any{"a": 1}},
	}
...
func TestDeprecatedPick(t *testing.T) {
	tc := []pesticide.TestCase{
		...
		{Name: "TestInvaidArguments", Input: `{{pick . }}`, ExpectedErr: "expected 2 arguments, got 1", Data: map[string]any{"a": 1}},
		{Name: "TestInvaidArgumentsType", Input: `{{pick 1 "a"}}`, ExpectedErr: "expected map or string, got int", Data: map[string]any{"a": 1}},
	}
...
func TestDeprecatedOmit(t *testing.T) {
	tc := []pesticide.TestCase{
		...
		{Name: "TestInvaidArguments", Input: `{{omit . }}`, ExpectedErr: "expected 2 arguments, got 1", Data: map[string]any{"a": 1}},
		{Name: "TestInvaidArgumentsType", Input: `{{omit 1 "a"}}`, ExpectedErr: "expected map or string, got int", Data: map[string]any{"a": 1}},
	}
