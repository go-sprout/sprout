...
func (sr *SlicesRegistry) RegisterFunctions(funcsMap registry.FunctionMap) {
	registry.AddFunction(funcsMap, "list", sr.List)
	registry.AddFunction(funcsMap, "append", sr.Append)
	registry.AddFunction(funcsMap, "prepend", sr.Prepend)
	registry.AddFunction(funcsMap, "concat", sr.Concat)
	registry.AddFunction(funcsMap, "chunk", sr.Chunk)
	registry.AddFunction(funcsMap, "uniq", sr.Uniq)
	registry.AddFunction(funcsMap, "compact", sr.Compact)
	registry.AddFunction(funcsMap, "slice", sr.Slice)
	registry.AddFunction(funcsMap, "has", sr.Has)
	registry.AddFunction(funcsMap, "without", sr.Without)
	registry.AddFunction(funcsMap, "rest", sr.Rest)
	registry.AddFunction(funcsMap, "initial", sr.Initial)
	registry.AddFunction(funcsMap, "first", sr.First)
	registry.AddFunction(funcsMap, "last", sr.Last)
	registry.AddFunction(funcsMap, "reverse", sr.Reverse)
	registry.AddFunction(funcsMap, "sortAlpha", sr.SortAlpha)
	registry.AddFunction(funcsMap, "splitList", sr.SplitList)
	registry.AddFunction(funcsMap, "strSlice", sr.StrSlice)
	registry.AddFunction(funcsMap, "until", sr.Until)
	registry.AddFunction(funcsMap, "untilStep", sr.UntilStep)
	registry.AddFunction(funcsMap, "mustAppend", sr.MustAppend)
	registry.AddFunction(funcsMap, "mustPrepend", sr.MustPrepend)
	registry.AddFunction(funcsMap, "mustChunk", sr.MustChunk)
	registry.AddFunction(funcsMap, "mustUniq", sr.MustUniq)
	registry.AddFunction(funcsMap, "mustCompact", sr.MustCompact)
	registry.AddFunction(funcsMap, "mustSlice", sr.MustSlice)
	registry.AddFunction(funcsMap, "mustHas", sr.MustHas)
	registry.AddFunction(funcsMap, "mustWithout", sr.MustWithout)
	registry.AddFunction(funcsMap, "mustRest", sr.MustRest)
	registry.AddFunction(funcsMap, "mustInitial", sr.MustInitial)
	registry.AddFunction(funcsMap, "mustFirst", sr.MustFirst)
	registry.AddFunction(funcsMap, "mustLast", sr.MustLast)
	registry.AddFunction(funcsMap, "mustReverse", sr.MustReverse)
}
